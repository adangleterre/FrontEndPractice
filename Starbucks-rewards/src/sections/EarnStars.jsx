        ...
        <section className='bg-[#f2f0eb] py-12 px-4'>
            <div className='max-w-[1440px] m-auto'>
                ...
                <div className='flex flex-wrap'>
                    ...
                    <StarsItem
                        imgSource='/images/illustrations/2A.png'
                        title='Preload'
                    ...
                    />
                    <StarsItem
                        imgSource='/images/illustrations/2B.webp'
