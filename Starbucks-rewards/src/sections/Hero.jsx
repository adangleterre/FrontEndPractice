export function Hero() {
    ...
    return (
        <section className='flex justify-center md:justify-start md:items-center bg-covers-green bg-hero-mobile md:bg-hero-desktop bg-contain md:bg-cover bg-no-repeat bg-right-bottom md:bg-bottom mb-8 md:mb-16'>
            <div className='w-full pb-[45%] md:py-[13%]'>
