        ...
        <div>
            ...
            <div className='flex flex-col w-11/12 mx-auto xl:flex-row'>
                ...
                <div className='bg-[#B1C5FF] p-[8vw] xl:p-32 xl:w-6/12 content-center'>
                    <p className='mb-5 text-xl lg:text-3xl'>We’re really proud of the work we’ve done so far. But there’s so much more to come. If you’d like to be a part of it, please join us.</p>
